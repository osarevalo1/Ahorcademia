...
static String respuestas(String respuesta) {
    
    String mensaje = "incorrecto";
    
          if ("EN LA PENULTIMA SILABA.".equals(respuesta))
    
                  {
                     mensaje= (String) "Respuesta Correcta";
                  }
          
           if ("5".equals(respuesta))
    
                  {
                     mensaje= (String) "Respuesta Correcta";
                  }
           
            if ("TIENE SEIS SILABAS".equals(respuesta))
    
                  {
                     mensaje= (String) "Respuesta Correcta";
                  }
            
            if ("6".equals(respuesta))
    
                  {
                     mensaje= (String) "Respuesta Correcta";
                  }
            
             if ("EL VERBO".equals(respuesta))
